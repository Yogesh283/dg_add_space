...
export default function MemberLayout({ children, title, subtitle }) {
    ...
    return (
        <div className="theme-light min-h-screen bg-[#f5f7fb] text-neutral-800">
            <div className="border-b border-neutral-200 bg-white py-1.5 text-center text-[11px] font-semibold tracking-wide text-[#ff5c1a]">
                DG Ad Space Member Panel — Your Game. Our Work. Your Income.
            </div>

            <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/90 shadow-sm backdrop-blur-lg">
                <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-2.5 md:px-8">
                    ...
                    <div className="hidden items-center gap-3 md:flex">
                        ...
                        <Link
                            href="/"
                            className="inline-flex items-center gap-1.5 rounded-xl border border-neutral-200 px-3 py-2 text-sm font-semibold text-neutral-700 hover:bg-neutral-50"
                        >
                    ...
                    <button
                        type="button"
                        className="rounded-xl border border-neutral-200 p-2 text-neutral-700 md:hidden"
                ...
                {menuOpen && (
                    <div className="border-t border-neutral-200 bg-white px-4 py-4 md:hidden">
                                ...
                                <Link
                                    ...
                                    className={`flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold ${
                                        isActive(currentUrl, link.href)
                                            ...
                                            : 'text-neutral-700 hover:bg-[#ff5c1a]/10 hover:text-[#ff5c1a]'
                                    }`}
                                >
                        ...
                        <div className="flex flex-col gap-2 border-t border-neutral-200 pt-3">
                            <Link href="/" className="rounded-lg px-3 py-2 text-sm font-semibold text-neutral-700">
                                Home
                            </Link>
                            <Link href="/game-store" className="rounded-lg px-3 py-2 text-sm font-semibold text-neutral-700">
                                Game Store
                            </Link>
                            <Link
                                href="/logout"
            ...
            <div className="mx-auto grid max-w-7xl gap-6 px-4 py-6 md:grid-cols-[240px_1fr] md:px-8 md:py-8">
                <aside className="pro-card hidden h-fit overflow-hidden md:block">
                    <div className="border-b border-neutral-200 bg-[#f8fafc] px-4 py-4">
                        <img
                            src="/img/logo.png"
                            alt="DG Ad Space"
                            className="mx-auto h-16 w-auto object-contain md:h-20"
                        />
                        <p className="mt-2 text-center text-[11px] font-semibold uppercase tracking-[0.16em] text-[#ff5c1a]">
                            Member Panel
                        </p>
                    </div>
            ...
            <footer className="mt-4 border-t border-neutral-200 bg-white text-neutral-800">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 px-4 py-8 md:flex-row md:justify-between md:px-8">
                    <div className="text-center md:text-left">
                        ...
                        />
                        <p className="mt-2 text-sm text-neutral-600">Member dashboard powered by DG Ad Space</p>
                    </div>
                    <div className="flex flex-wrap justify-center gap-4 text-sm text-neutral-600">
                        <Link href="/" className="hover:text-[#ff5c1a]">
                            Home
                        </Link>
                        <Link href="/game-store" className="hover:text-[#ff5c1a]">
                            Game Store
                        </Link>
                        <Link href="/member" className="hover:text-[#ff5c1a]">
                            Dashboard
                        </Link>
                    </div>
                </div>
